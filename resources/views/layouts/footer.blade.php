    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="#" class="hover:text-teal-300">الرئيسية</a></li>
            <li><a href="#" class="hover:text-teal-300">المنتجات</a></li>
            <li><a href="#" class="hover:text-teal-300">معلومات عنا</a></li>
            <li><a href="#" class="hover:text-teal-300">تواصل معنا</a></li>
          </ul>
        </div>
        <!-- النشرة البريدية -->
        <div>
