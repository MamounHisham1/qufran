<x-app-layout>
    <x-container>
        <main class="flex-grow md:p-5" x-data="home()">
            ...
            <button x-on:click="read = ! read" x-text="read ? 'اﻹنتقال لصفحة التسميع' : 'اﻹنتقال لصفحة القراءة'" class="text-blue-600"></button>
            <div class="mt-2" x-show="read == true">
                <ul class="flex flex-wrap items-center gap-5">
                    <template x-for="(ayah, key) in surah">
                        <li>
                            <span class="block group p-3">
                                <span class="font-bold text-xl group-hover:text-teal-600" x-text="ayah.text_uthmani"></span>
