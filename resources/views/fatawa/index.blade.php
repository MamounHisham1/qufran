            ...
            <div class="mt-5 border-t border-teal-700">
                ...
                @guest
                    <a href="{{ route('register') }}"
                        class="mt-5 block hover:text-blue-600 hover:underline">
                ...
                @auth
                    <form action="{{ route('fatawa.store') }}" method="POST" class="max-w-sm mx-auto">
                        @csrf
                        <label for="title" class="block mb-2 font-medium text-gray-900 mt-5 lg:mt-0">{{ __('The question') }}</label>
                        ...
                        <div class="flex items-center my-4">
                            <input checked id="checkbox-1" type="checkbox" value="1" name="ananymos"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                            <label for="checkbox-1" class="ms-2 text-sm font-medium text-gray-900">{{ __('Ananymos') }}</label>
                        </div>
                        <div class="flex items-center my-4">
